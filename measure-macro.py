...
while(True):
    ...
    p = Popen(["timeout", str(TIMEOUT_SECONDS), "perf", "stat", "-e", "cycles:u,instructions:u"] + [binary] + binary_parameters, stdout=PIPE, stderr=STDOUT, stdin=PIPE, bufsize=1, universal_newlines=True)
